...
private let fallbackStrings: [String: String] = [
    ...
    "settings.permissions.motion": "Motion",
    "settings.permissions.camera.reason": "Detects your posture from webcam frames. Frames are processed locally and never leave your Mac.",
    "settings.permissions.motion.reason": "Reads head-motion data from paired AirPods for posture detection.",
    "settings.permissions.bluetooth.reason": "Detects paired AirPods for head motion tracking.",
    "settings.permissions.notifications.reason": "Shows posture alerts, reminders, and screen break prompts.",
    "settings.permissions.focus.reason": "Checks whether a Focus mode is active so tracking can pause automatically.",
    ...
    "settings.resetAll.description": "Resets selected settings to their default values.",
    "settings.resetAll.button": "Reset...",
    "settings.resetAll.confirmTitle": "Reset Settings?",
    "settings.resetAll.confirm": "Settings will be reset to their default values and will restore the app to its original state.",
    ...
    "autoPause.focus.help": "Pauses tracking while any Focus mode is active. macOS only lets apps know whether Focus is on — not which mode — so this applies to all Focus modes and never requires App Management access.",
